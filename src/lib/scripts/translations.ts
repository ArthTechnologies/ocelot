export default {
  "en-US": {
    ...
    "software.title": "Change Software",
    "software.versionNote": "Software can only be changed to the same Minecraft version",
    "software.current": "Current Software",
    "software.select": "Select Software & Version",
    "warning.type0": "Warning: Any plugins including Geyser will stop working",
    "warning.type1": "Warning: The world will need to be deleted to change software",
    "warning.type2": "Warning: Snapshots are experimental. Your world may not be able to update to future versions",
    "warning.type3": "This software switch is not supported",
    save: "Save",
    ...
    "help.button.getHelpOnOurDiscord": "Discord Support",
    ...
    "alert.fileUploaded": "File Uploaded",
    ...
    "software.neoForge": "NeoForge - A faster version of Forge.",
    ...
    "software.vanilla": "Vanilla - The original Minecraft server software; poor performance.",
  ...
  "es-ES": {
    ...
    "signin.h2": "Ingrese sus detalles de cuenta para continuar.",
    ...
    "software.title": "Cambiar Software",
    "software.versionNote": "El software solo se puede cambiar a la misma versión de Minecraft",
    "software.current": "Software Actual",
    "software.select": "Seleccionar Software y Versión",
    "warning.type0": "Advertencia: Los plugins, incluido Geyser, dejarán de funcionar",
    "warning.type1": "Advertencia: El mundo debe ser eliminado para cambiar de software",
    "warning.type2": "Advertencia: Las snapshots son experimentales. Su mundo podría no ser capaz de actualizar a versiones futuras",
    "warning.type3": "Este cambio de software no es compatible",
    save: "Salvar",
    ...
    "help.button.getHelpOnOurDiscord": "Soporte de Discord",
    ...
    "alert.fileUploaded": "Archivo subido",
    ...
    "software.neoForge": "NeoForge - Una versión más rápida de Forge.",
    ...
    "software.vanilla": "Vanilla - El software de servidor original de Minecraft.",
