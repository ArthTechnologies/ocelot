export default {
  "en-US": {
    ...
    "subscribe.didYouKnow.price": "Our cheapest plan is half the price of the leading competitor Apex Hosting's cheapest plan.",
  ...
  "es-ES": {
    ...
    "subscribe.didYouKnow.price": "Nuestro plan más barato cuesta la mitad del precio del plan más barato del competidor líder Apex Hosting.",
