...
<div class="md:flex relative">
  ...
  >
    ...
    <div class="flex mb-8">
      <div class="flex flex-col gap-2">
        ...
        />
        <button
          class="btn btn-sm my-0.5 w-full pointer-events-none hidden md:flex"
          id="basicSelect"
        ...
        <a
          ...
          class="btn btn-neutral btn-sm my-0.5 w-full md:hidden"
      ...
      <div class="flex flex-col gap-2">
        ...
        />
        <button
          class="btn btn-neutral btn-sm my-0.5 w-full hidden md:flex"
          id="moddedSelect"
  ...
  <div class="hidden md:flex min-h-screen w-screen bg-[#525f7f]">
    {#if plan == "basic"}
      <iframe src="/subscribe/basic" class="w-full h-full" frameborder="0" />
    {:else if plan == "modded"}
      <iframe src="/subscribe/modded" class="w-full h-full" frameborder="0" />
    {/if}
  </div>
</div>
